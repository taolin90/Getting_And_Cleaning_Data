...
Raw dataset information and attribute information can be found in details from link:
...
Read in features.txt, activity_labels.txt, subject_test.txt, X_test.txt, y_test.txt, subject_train.txt, X_train.txt, y_train.txt
Bind train and test dataset for activity, subject and datatable X
...
Use group_by() and summarise_all() in dplyr to get average number for each variable by each activity and subject
